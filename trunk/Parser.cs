...
// GPPG version 1.4.0
// Machine:  SANVIW091414
// DateTime: 6/28/2011 6:20:17 PM
// UserName: sanviw
...
internal enum Tokens {
    ...
    TCHAR=19,WHILE=20,FOR=21,IF=22,ELSE=23,SELF=24,
    CLASS=25,EXTENDS=26,NEW=27,RETURN=28,TRUE=29,FALSE=30,
    READONLY=31,NECESSARY=32,PRIVATE=33,PUBLIC=34,AMP=35,LITERAL_INT=36,
    LITERAL_REAL=37,LITERAL_STRING=38,LITERAL_CHAR=39,IDENTIFIER=40,ASSIGN=41,OR=42,
    AND=43,INCREMENT=44,DECREMENT=45,EXP=46,SMALLER=47,GREATER=48,
    SMEQ=49,GTEQ=50,EQ=51,NEQ=52,PLUS=53,MINUS=54,
    TIMES=55,DIVIDE=56,MOD=57,UMINUS=58,LPAREN=59,NOT=60,
    LBRACKET=61};
...
#pragma warning restore 649
  ...
  static Parser() {
    states[0] = new State(new int[]{25,6,1,200,2,-3},new int[]{-1,1,-2,3,-4,4});
    states[1] = new State(new int[]{2,2});
    states[2] = new State(-1);
    states[3] = new State(-2);
    states[4] = new State(new int[]{25,6,1,200,2,-3},new int[]{-2,5,-4,4});
    states[5] = new State(-4);
    states[6] = new State(new int[]{40,7});
    states[7] = new State(new int[]{5,8,26,195});
    states[8] = new State(new int[]{33,191,34,192,32,193,31,194,6,-8,40,-13,14,-13,17,-13,18,-13,16,-13,15,-13,19,-13},new int[]{-6,9,-7,11,-19,13,-20,189});
    states[9] = new State(new int[]{6,10});
    states[10] = new State(-5);
    states[11] = new State(new int[]{33,191,34,192,32,193,31,194,6,-8,40,-13,14,-13,17,-13,18,-13,16,-13,15,-13,19,-13},new int[]{-6,12,-7,11,-19,13,-20,189});
    states[12] = new State(-9);
    states[13] = new State(new int[]{40,182,14,108,17,109,18,110,16,111,15,112,19,113},new int[]{-17,14,-18,106});
    states[14] = new State(new int[]{40,15});
    states[15] = new State(new int[]{3,16,59,17});
    states[16] = new State(-10);
    states[17] = new State(new int[]{31,98,14,108,17,109,18,110,16,111,15,112,40,179,19,113,4,-35},new int[]{-8,18,-9,172,-10,173,-21,176,-17,180,-18,106});
    states[18] = new State(new int[]{4,19});
    states[19] = new State(new int[]{5,20});
    states[20] = new State(new int[]{3,25,36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,123,24,86,13,87,27,89,14,108,17,109,18,110,16,111,15,112,19,113,5,130,20,133,21,138,22,150,28,157,1,161,6,-19},new int[]{-3,21,-5,23,-13,26,-15,60,-16,119,-14,88,-17,124,-18,106});
    states[21] = new State(new int[]{6,22});
    states[22] = new State(-11);
    states[23] = new State(new int[]{3,25,36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,123,24,86,13,87,27,89,14,108,17,109,18,110,16,111,15,112,19,113,5,130,20,133,21,138,22,150,28,157,1,161,6,-19},new int[]{-3,24,-5,23,-13,26,-15,60,-16,119,-14,88,-17,124,-18,106});
    states[24] = new State(-20);
    states[25] = new State(-21);
    states[26] = new State(new int[]{3,27,43,28,42,30,47,32,48,34,49,36,50,38,51,40,52,42,53,44,54,46,55,48,56,50,57,52,46,54,35,56,44,58,45,59});
    states[27] = new State(-22);
    states[28] = new State(new int[]{36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,78,24,86,13,87,27,89},new int[]{-13,29,-15,60,-16,74,-14,88});
    states[29] = new State(new int[]{43,-42,42,-42,47,32,48,34,49,36,50,38,51,40,52,42,53,44,54,46,55,48,56,50,57,52,46,-42,35,56,44,-42,45,-42,3,-42,4,-42,7,-42,11,-42,10,-42});
    states[30] = new State(new int[]{36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,78,24,86,13,87,27,89},new int[]{-13,31,-15,60,-16,74,-14,88});
    states[31] = new State(new int[]{43,-43,42,-43,47,32,48,34,49,36,50,38,51,40,52,42,53,44,54,46,55,48,56,50,57,52,46,-43,35,56,44,-43,45,-43,3,-43,4,-43,7,-43,11,-43,10,-43});
    states[32] = new State(new int[]{36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,78,24,86,13,87,27,89},new int[]{-13,33,-15,60,-16,74,-14,88});
    states[33] = new State(new int[]{43,-44,42,-44,47,-44,48,-44,49,-44,50,-44,51,-44,52,-44,53,44,54,46,55,48,56,50,57,52,46,-44,35,56,44,-44,45,-44,3,-44,4,-44,7,-44,11,-44,10,-44});
    states[34] = new State(new int[]{36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,78,24,86,13,87,27,89},new int[]{-13,35,-15,60,-16,74,-14,88});
    states[35] = new State(new int[]{43,-45,42,-45,47,-45,48,-45,49,-45,50,-45,51,-45,52,-45,53,44,54,46,55,48,56,50,57,52,46,-45,35,56,44,-45,45,-45,3,-45,4,-45,7,-45,11,-45,10,-45});
    states[36] = new State(new int[]{36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,78,24,86,13,87,27,89},new int[]{-13,37,-15,60,-16,74,-14,88});
    states[37] = new State(new int[]{43,-46,42,-46,47,-46,48,-46,49,-46,50,-46,51,-46,52,-46,53,44,54,46,55,48,56,50,57,52,46,-46,35,56,44,-46,45,-46,3,-46,4,-46,7,-46,11,-46,10,-46});
    states[38] = new State(new int[]{36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,78,24,86,13,87,27,89},new int[]{-13,39,-15,60,-16,74,-14,88});
    states[39] = new State(new int[]{43,-47,42,-47,47,-47,48,-47,49,-47,50,-47,51,-47,52,-47,53,44,54,46,55,48,56,50,57,52,46,-47,35,56,44,-47,45,-47,3,-47,4,-47,7,-47,11,-47,10,-47});
    states[40] = new State(new int[]{36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,78,24,86,13,87,27,89},new int[]{-13,41,-15,60,-16,74,-14,88});
    states[41] = new State(new int[]{43,-48,42,-48,47,-48,48,-48,49,-48,50,-48,51,-48,52,-48,53,44,54,46,55,48,56,50,57,52,46,-48,35,56,44,-48,45,-48,3,-48,4,-48,7,-48,11,-48,10,-48});
    states[42] = new State(new int[]{36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,78,24,86,13,87,27,89},new int[]{-13,43,-15,60,-16,74,-14,88});
    states[43] = new State(new int[]{43,-49,42,-49,47,-49,48,-49,49,-49,50,-49,51,-49,52,-49,53,44,54,46,55,48,56,50,57,52,46,-49,35,56,44,-49,45,-49,3,-49,4,-49,7,-49,11,-49,10,-49});
    states[44] = new State(new int[]{36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,78,24,86,13,87,27,89},new int[]{-13,45,-15,60,-16,74,-14,88});
    states[45] = new State(-50);
    states[46] = new State(new int[]{36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,78,24,86,13,87,27,89},new int[]{-13,47,-15,60,-16,74,-14,88});
    states[47] = new State(-51);
    states[48] = new State(new int[]{36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,78,24,86,13,87,27,89},new int[]{-13,49,-15,60,-16,74,-14,88});
    states[49] = new State(-52);
    states[50] = new State(new int[]{36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,78,24,86,13,87,27,89},new int[]{-13,51,-15,60,-16,74,-14,88});
    states[51] = new State(-53);
    states[52] = new State(new int[]{36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,78,24,86,13,87,27,89},new int[]{-13,53,-15,60,-16,74,-14,88});
    states[53] = new State(-54);
    states[54] = new State(new int[]{36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,78,24,86,13,87,27,89},new int[]{-13,55,-15,60,-16,74,-14,88});
    states[55] = new State(new int[]{43,-55,42,-55,47,32,48,34,49,36,50,38,51,40,52,42,53,44,54,46,55,48,56,50,57,52,46,-55,35,56,44,-55,45,-55,3,-55,4,-55,7,-55,11,-55,10,-55});
    states[56] = new State(new int[]{36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,78,24,86,13,87,27,89},new int[]{-13,57,-15,60,-16,74,-14,88});
    ...
    states[65] = new State(-94);
    states[66] = new State(-95);
    states[67] = new State(new int[]{36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,78,24,86,13,87,27,89},new int[]{-13,68,-15,60,-16,74,-14,88});
    states[68] = new State(-58);
    states[69] = new State(new int[]{36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,78,24,86,13,87,27,89},new int[]{-13,70,-15,60,-16,74,-14,88});
    states[70] = new State(-59);
    states[71] = new State(new int[]{36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,78,24,86,13,87,27,89},new int[]{-13,72,-15,60,-16,74,-14,88});
    states[72] = new State(new int[]{4,73,43,28,42,30,47,32,48,34,49,36,50,38,51,40,52,42,53,44,54,46,55,48,56,50,57,52,46,54,35,56,44,58,45,59});
    states[73] = new State(-62);
    states[74] = new State(new int[]{61,75,9,114,43,-63,42,-63,47,-63,48,-63,49,-63,50,-63,51,-63,52,-63,53,-63,54,-63,55,-63,56,-63,57,-63,46,-63,35,-63,44,-63,45,-63,3,-63,4,-63,7,-63,11,-63,10,-63});
    states[75] = new State(new int[]{36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,78,24,86,13,87,27,89},new int[]{-13,76,-15,60,-16,74,-14,88});
    states[76] = new State(new int[]{7,77,43,28,42,30,47,32,48,34,49,36,50,38,51,40,52,42,53,44,54,46,55,48,56,50,57,52,46,54,35,56,44,58,45,59});
    states[77] = new State(-69);
    states[78] = new State(new int[]{59,79,61,-68,9,-68,43,-68,42,-68,47,-68,48,-68,49,-68,50,-68,51,-68,52,-68,53,-68,54,-68,55,-68,56,-68,57,-68,46,-68,35,-68,44,-68,45,-68,3,-68,4,-68,7,-68,11,-68,10,-68});
    states[79] = new State(new int[]{36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,78,24,86,13,87,27,89,31,98,4,-75},new int[]{-12,80,-11,82,-13,83,-15,60,-16,74,-14,88,-21,94});
    states[80] = new State(new int[]{4,81});
    states[81] = new State(-73);
    states[82] = new State(-76);
    states[83] = new State(new int[]{43,28,42,30,47,32,48,34,49,36,50,38,51,40,52,42,53,44,54,46,55,48,56,50,57,52,46,54,35,56,44,58,45,59,11,84,4,-77});
    states[84] = new State(new int[]{36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,78,24,86,13,87,27,89,31,98},new int[]{-11,85,-13,83,-15,60,-16,74,-14,88,-21,94});
    states[85] = new State(-80);
    states[86] = new State(-71);
    states[87] = new State(-72);
    states[88] = new State(-64);
    states[89] = new State(new int[]{40,90,14,108,17,109,18,110,16,111,15,112,19,113},new int[]{-17,99,-18,106});
    states[90] = new State(new int[]{59,91,8,-88,61,-88});
    states[91] = new State(new int[]{36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,78,24,86,13,87,27,89,31,98,4,-75},new int[]{-12,92,-11,82,-13,83,-15,60,-16,74,-14,88,-21,94});
    states[92] = new State(new int[]{4,93});
    states[93] = new State(-65);
    states[94] = new State(new int[]{40,95});
    states[95] = new State(new int[]{11,96,4,-78});
    states[96] = new State(new int[]{36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,78,24,86,13,87,27,89,31,98},new int[]{-11,97,-13,83,-15,60,-16,74,-14,88,-21,94});
    states[97] = new State(-79);
    states[98] = new State(-39);
    states[99] = new State(new int[]{61,100});
    states[100] = new State(new int[]{36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,78,24,86,13,87,27,89},new int[]{-13,101,-15,60,-16,74,-14,88});
    states[101] = new State(new int[]{10,102,7,105,43,28,42,30,47,32,48,34,49,36,50,38,51,40,52,42,53,44,54,46,55,48,56,50,57,52,46,54,35,56,44,58,45,59});
    states[102] = new State(new int[]{36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,78,24,86,13,87,27,89},new int[]{-13,103,-15,60,-16,74,-14,88});
    states[103] = new State(new int[]{7,104,43,28,42,30,47,32,48,34,49,36,50,38,51,40,52,42,53,44,54,46,55,48,56,50,57,52,46,54,35,56,44,58,45,59});
    states[104] = new State(-66);
    states[105] = new State(-67);
    states[106] = new State(new int[]{8,107,40,-81,61,-81});
    states[107] = new State(-82);
    states[108] = new State(-83);
    states[109] = new State(-84);
    ...
    states[115] = new State(new int[]{59,116,61,-70,9,-70,41,-70,3,-70,43,-70,42,-70,47,-70,48,-70,49,-70,50,-70,51,-70,52,-70,53,-70,54,-70,55,-70,56,-70,57,-70,46,-70,35,-70,44,-70,45,-70,4,-70,7,-70,11,-70,10,-70});
    states[116] = new State(new int[]{36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,78,24,86,13,87,27,89,31,98,4,-75},new int[]{-12,117,-11,82,-13,83,-15,60,-16,74,-14,88,-21,94});
    states[117] = new State(new int[]{4,118});
    states[118] = new State(-74);
    states[119] = new State(new int[]{61,75,9,114,41,120,3,-63,43,-63,42,-63,47,-63,48,-63,49,-63,50,-63,51,-63,52,-63,53,-63,54,-63,55,-63,56,-63,57,-63,46,-63,35,-63,44,-63,45,-63});
    states[120] = new State(new int[]{36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,78,24,86,13,87,27,89},new int[]{-13,121,-15,60,-16,74,-14,88});
    states[121] = new State(new int[]{3,122,43,28,42,30,47,32,48,34,49,36,50,38,51,40,52,42,53,44,54,46,55,48,56,50,57,52,46,54,35,56,44,58,45,59});
    states[122] = new State(-25);
    states[123] = new State(new int[]{59,79,61,-68,9,-68,41,-68,3,-68,43,-68,42,-68,47,-68,48,-68,49,-68,50,-68,51,-68,52,-68,53,-68,54,-68,55,-68,56,-68,57,-68,46,-68,35,-68,44,-68,45,-68,8,-88,40,-88});
    states[124] = new State(new int[]{40,125});
    states[125] = new State(new int[]{3,126,41,127});
    states[126] = new State(-23);
    states[127] = new State(new int[]{36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,78,24,86,13,87,27,89},new int[]{-13,128,-15,60,-16,74,-14,88});
    states[128] = new State(new int[]{3,129,43,28,42,30,47,32,48,34,49,36,50,38,51,40,52,42,53,44,54,46,55,48,56,50,57,52,46,54,35,56,44,58,45,59});
    states[129] = new State(-24);
    states[130] = new State(new int[]{3,25,36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,123,24,86,13,87,27,89,14,108,17,109,18,110,16,111,15,112,19,113,5,130,20,133,21,138,22,150,28,157,1,161,6,-19},new int[]{-3,131,-5,23,-13,26,-15,60,-16,119,-14,88,-17,124,-18,106});
    states[131] = new State(new int[]{6,132});
    states[132] = new State(-26);
    states[133] = new State(new int[]{59,134});
    states[134] = new State(new int[]{36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,78,24,86,13,87,27,89},new int[]{-13,135,-15,60,-16,74,-14,88});
    states[135] = new State(new int[]{4,136,43,28,42,30,47,32,48,34,49,36,50,38,51,40,52,42,53,44,54,46,55,48,56,50,57,52,46,54,35,56,44,58,45,59});
    states[136] = new State(new int[]{3,25,36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,123,24,86,13,87,27,89,14,108,17,109,18,110,16,111,15,112,19,113,5,130,20,133,21,138,22,150,28,157,1,161},new int[]{-5,137,-13,26,-15,60,-16,119,-14,88,-17,124,-18,106});
    states[137] = new State(-27);
    states[138] = new State(new int[]{59,139});
    states[139] = new State(new int[]{40,163,14,108,17,109,18,110,16,111,15,112,19,113},new int[]{-17,140,-18,106});
    states[140] = new State(new int[]{40,141});
    states[141] = new State(new int[]{41,142});
    states[142] = new State(new int[]{36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,78,24,86,13,87,27,89},new int[]{-13,143,-15,60,-16,74,-14,88});
    states[143] = new State(new int[]{3,144,43,28,42,30,47,32,48,34,49,36,50,38,51,40,52,42,53,44,54,46,55,48,56,50,57,52,46,54,35,56,44,58,45,59});
    states[144] = new State(new int[]{36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,78,24,86,13,87,27,89},new int[]{-13,145,-15,60,-16,74,-14,88});
    states[145] = new State(new int[]{3,146,43,28,42,30,47,32,48,34,49,36,50,38,51,40,52,42,53,44,54,46,55,48,56,50,57,52,46,54,35,56,44,58,45,59});
    states[146] = new State(new int[]{36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,78,24,86,13,87,27,89},new int[]{-13,147,-15,60,-16,74,-14,88});
    states[147] = new State(new int[]{4,148,43,28,42,30,47,32,48,34,49,36,50,38,51,40,52,42,53,44,54,46,55,48,56,50,57,52,46,54,35,56,44,58,45,59});
    states[148] = new State(new int[]{3,25,36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,123,24,86,13,87,27,89,14,108,17,109,18,110,16,111,15,112,19,113,5,130,20,133,21,138,22,150,28,157,1,161},new int[]{-5,149,-13,26,-15,60,-16,119,-14,88,-17,124,-18,106});
    states[149] = new State(-28);
    states[150] = new State(new int[]{59,151});
    states[151] = new State(new int[]{36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,78,24,86,13,87,27,89},new int[]{-13,152,-15,60,-16,74,-14,88});
    states[152] = new State(new int[]{4,153,43,28,42,30,47,32,48,34,49,36,50,38,51,40,52,42,53,44,54,46,55,48,56,50,57,52,46,54,35,56,44,58,45,59});
    states[153] = new State(new int[]{3,25,36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,123,24,86,13,87,27,89,14,108,17,109,18,110,16,111,15,112,19,113,5,130,20,133,21,138,22,150,28,157,1,161},new int[]{-5,154,-13,26,-15,60,-16,119,-14,88,-17,124,-18,106});
    states[154] = new State(new int[]{23,155,3,-30,36,-30,37,-30,38,-30,39,-30,29,-30,30,-30,54,-30,60,-30,59,-30,40,-30,24,-30,13,-30,27,-30,14,-30,17,-30,18,-30,16,-30,15,-30,19,-30,5,-30,20,-30,21,-30,22,-30,28,-30,1,-30,6,-30});
    states[155] = new State(new int[]{3,25,36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,123,24,86,13,87,27,89,14,108,17,109,18,110,16,111,15,112,19,113,5,130,20,133,21,138,22,150,28,157,1,161},new int[]{-5,156,-13,26,-15,60,-16,119,-14,88,-17,124,-18,106});
    states[156] = new State(-31);
    states[157] = new State(new int[]{3,158,36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,78,24,86,13,87,27,89},new int[]{-13,159,-15,60,-16,74,-14,88});
    states[158] = new State(-32);
    states[159] = new State(new int[]{3,160,43,28,42,30,47,32,48,34,49,36,50,38,51,40,52,42,53,44,54,46,55,48,56,50,57,52,46,54,35,56,44,58,45,59});
    states[160] = new State(-33);
    states[161] = new State(new int[]{3,162});
    states[162] = new State(-34);
    states[163] = new State(new int[]{12,164,8,-88,40,-88});
    states[164] = new State(new int[]{61,165});
    states[165] = new State(new int[]{36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,78,24,86,13,87,27,89},new int[]{-13,166,-15,60,-16,74,-14,88});
    states[166] = new State(new int[]{10,167,43,28,42,30,47,32,48,34,49,36,50,38,51,40,52,42,53,44,54,46,55,48,56,50,57,52,46,54,35,56,44,58,45,59});
    states[167] = new State(new int[]{36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,78,24,86,13,87,27,89},new int[]{-13,168,-15,60,-16,74,-14,88});
    states[168] = new State(new int[]{7,169,43,28,42,30,47,32,48,34,49,36,50,38,51,40,52,42,53,44,54,46,55,48,56,50,57,52,46,54,35,56,44,58,45,59});
    states[169] = new State(new int[]{4,170});
    states[170] = new State(new int[]{3,25,36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,123,24,86,13,87,27,89,14,108,17,109,18,110,16,111,15,112,19,113,5,130,20,133,21,138,22,150,28,157,1,161},new int[]{-5,171,-13,26,-15,60,-16,119,-14,88,-17,124,-18,106});
    states[171] = new State(-29);
    states[172] = new State(-36);
    states[173] = new State(new int[]{11,174,4,-37});
    states[174] = new State(new int[]{31,98,14,108,17,109,18,110,16,111,15,112,40,179,19,113},new int[]{-9,175,-10,173,-21,176,-17,180,-18,106});
    states[175] = new State(-38);
    states[176] = new State(new int[]{14,108,17,109,18,110,16,111,15,112,40,179,19,113},new int[]{-17,177,-18,106});
    states[177] = new State(new int[]{40,178});
    states[178] = new State(-40);
    states[179] = new State(-88);
    states[180] = new State(new int[]{40,181});
    states[181] = new State(-41);
    states[182] = new State(new int[]{59,183,8,-88,40,-88});
    states[183] = new State(new int[]{31,98,14,108,17,109,18,110,16,111,15,112,40,179,19,113,4,-35},new int[]{-8,184,-9,172,-10,173,-21,176,-17,180,-18,106});
    states[184] = new State(new int[]{4,185});
    states[185] = new State(new int[]{5,186});
    states[186] = new State(new int[]{3,25,36,61,37,62,38,63,39,64,29,65,30,66,54,67,60,69,59,71,40,123,24,86,13,87,27,89,14,108,17,109,18,110,16,111,15,112,19,113,5,130,20,133,21,138,22,150,28,157,1,161,6,-19},new int[]{-3,187,-5,23,-13,26,-15,60,-16,119,-14,88,-17,124,-18,106});
    states[187] = new State(new int[]{6,188});
    states[188] = new State(-12);
    states[189] = new State(new int[]{33,191,34,192,32,193,31,194,40,-13,14,-13,17,-13,18,-13,16,-13,15,-13,19,-13},new int[]{-19,190,-20,189});
    states[190] = new State(-14);
    states[191] = new State(-15);
    states[192] = new State(-16);
    states[193] = new State(-17);
    states[194] = new State(-18);
    states[195] = new State(new int[]{40,196});
    states[196] = new State(new int[]{5,197});
    states[197] = new State(new int[]{33,191,34,192,32,193,31,194,6,-8,40,-13,14,-13,17,-13,18,-13,16,-13,15,-13,19,-13},new int[]{-6,198,-7,11,-19,13,-20,189});
    states[198] = new State(new int[]{6,199});
    states[199] = new State(-6);
    states[200] = new State(new int[]{3,201});
    states[201] = new State(-7);

    rules[1] = new Rule(-22, new int[]{-1,2});
    rules[2] = new Rule(-1, new int[]{-2});
    rules[3] = new Rule(-2, new int[]{});
    rules[4] = new Rule(-2, new int[]{-4,-2});
    rules[5] = new Rule(-4, new int[]{25,40,5,-6,6});
    rules[6] = new Rule(-4, new int[]{25,40,26,40,5,-6,6});
    rules[7] = new Rule(-4, new int[]{1,3});
    rules[8] = new Rule(-6, new int[]{});
    rules[9] = new Rule(-6, new int[]{-7,-6});
    rules[10] = new Rule(-7, new int[]{-19,-17,40,3});
    rules[11] = new Rule(-7, new int[]{-19,-17,40,59,-8,4,5,-3,6});
    rules[12] = new Rule(-7, new int[]{-19,40,59,-8,4,5,-3,6});
    rules[13] = new Rule(-19, new int[]{});
    rules[14] = new Rule(-19, new int[]{-20,-19});
    rules[15] = new Rule(-20, new int[]{33});
    rules[16] = new Rule(-20, new int[]{34});
    rules[17] = new Rule(-20, new int[]{32});
    ...
    rules[23] = new Rule(-5, new int[]{-17,40,3});
    rules[24] = new Rule(-5, new int[]{-17,40,41,-13,3});
    rules[25] = new Rule(-5, new int[]{-16,41,-13,3});
    rules[26] = new Rule(-5, new int[]{5,-3,6});
    rules[27] = new Rule(-5, new int[]{20,59,-13,4,-5});
    rules[28] = new Rule(-5, new int[]{21,59,-17,40,41,-13,3,-13,3,-13,4,-5});
    rules[29] = new Rule(-5, new int[]{21,59,40,12,61,-13,10,-13,7,4,-5});
    rules[30] = new Rule(-5, new int[]{22,59,-13,4,-5});
    rules[31] = new Rule(-5, new int[]{22,59,-13,4,-5,23,-5});
    rules[32] = new Rule(-5, new int[]{28,3});
    rules[33] = new Rule(-5, new int[]{28,-13,3});
    ...
    rules[39] = new Rule(-21, new int[]{31});
    rules[40] = new Rule(-10, new int[]{-21,-17,40});
    rules[41] = new Rule(-10, new int[]{-17,40});
    rules[42] = new Rule(-13, new int[]{-13,43,-13});
    rules[43] = new Rule(-13, new int[]{-13,42,-13});
    rules[44] = new Rule(-13, new int[]{-13,47,-13});
    rules[45] = new Rule(-13, new int[]{-13,48,-13});
    rules[46] = new Rule(-13, new int[]{-13,49,-13});
    rules[47] = new Rule(-13, new int[]{-13,50,-13});
    rules[48] = new Rule(-13, new int[]{-13,51,-13});
    rules[49] = new Rule(-13, new int[]{-13,52,-13});
    rules[50] = new Rule(-13, new int[]{-13,53,-13});
    rules[51] = new Rule(-13, new int[]{-13,54,-13});
    rules[52] = new Rule(-13, new int[]{-13,55,-13});
    rules[53] = new Rule(-13, new int[]{-13,56,-13});
    rules[54] = new Rule(-13, new int[]{-13,57,-13});
    rules[55] = new Rule(-13, new int[]{-13,46,-13});
    rules[56] = new Rule(-13, new int[]{-13,35,-13});
    rules[57] = new Rule(-13, new int[]{-15});
    rules[58] = new Rule(-13, new int[]{54,-13});
    rules[59] = new Rule(-13, new int[]{60,-13});
    rules[60] = new Rule(-13, new int[]{-13,44});
    rules[61] = new Rule(-13, new int[]{-13,45});
    rules[62] = new Rule(-13, new int[]{59,-13,4});
    rules[63] = new Rule(-13, new int[]{-16});
    rules[64] = new Rule(-13, new int[]{-14});
    rules[65] = new Rule(-13, new int[]{27,40,59,-12,4});
    rules[66] = new Rule(-13, new int[]{27,-17,61,-13,10,-13,7});
    rules[67] = new Rule(-13, new int[]{27,-17,61,-13,7});
    rules[68] = new Rule(-16, new int[]{40});
    rules[69] = new Rule(-16, new int[]{-16,61,-13,7});
    rules[70] = new Rule(-16, new int[]{-16,9,40});
    rules[71] = new Rule(-16, new int[]{24});
    rules[72] = new Rule(-16, new int[]{13});
    rules[73] = new Rule(-14, new int[]{40,59,-12,4});
    rules[74] = new Rule(-14, new int[]{-16,9,40,59,-12,4});
    rules[75] = new Rule(-12, new int[]{});
    rules[76] = new Rule(-12, new int[]{-11});
    rules[77] = new Rule(-11, new int[]{-13});
    rules[78] = new Rule(-11, new int[]{-21,40});
    rules[79] = new Rule(-11, new int[]{-21,40,11,-11});
    ...
    rules[88] = new Rule(-18, new int[]{40});
    rules[89] = new Rule(-18, new int[]{19});
    rules[90] = new Rule(-15, new int[]{36});
    rules[91] = new Rule(-15, new int[]{37});
    rules[92] = new Rule(-15, new int[]{38});
    rules[93] = new Rule(-15, new int[]{39});
    rules[94] = new Rule(-15, new int[]{29});
    rules[95] = new Rule(-15, new int[]{30});
  }
...
{ CurrentSemanticValue.Expression = new ASTInstantiateArray(ValueStack[ValueStack.Depth-4].Type, new ASTInteger(0), ValueStack[ValueStack.Depth-2].Expression); CurrentSemanticValue.Expression.Location = CurrentLocationSpan; }
        break;
...
{ CurrentSemanticValue.Type = new ASTTypeClass(ValueStack[ValueStack.Depth-1].Token.Value); CurrentSemanticValue.Type.Location = CurrentLocationSpan; }
        break;
      case 89: // integralType -> TCHAR
{ CurrentSemanticValue.Type = new ASTTypeChar(); CurrentSemanticValue.Type.Location = CurrentLocationSpan; }
        break;
      case 90: // literal -> LITERAL_INT
...
{ CurrentSemanticValue.Expression = new ASTReal(Double.Parse(ValueStack[ValueStack.Depth-1].Token.Value)); CurrentSemanticValue.Expression.Location = CurrentLocationSpan; }
        break;
      case 92: // literal -> LITERAL_STRING
{ CurrentSemanticValue.Expression = new ASTString(ValueStack[ValueStack.Depth-1].Token.Value); CurrentSemanticValue.Expression.Location = CurrentLocationSpan; }
        break;
      case 93: // literal -> LITERAL_CHAR
{ CurrentSemanticValue.Expression = new ASTChar(ValueStack[ValueStack.Depth-1].Token.Value); CurrentSemanticValue.Expression.Location = CurrentLocationSpan; }
        break;
