...
#pragma warning restore 649
  ...
  static Parser() {
    states[0] = new State(new int[]{24,6,1,190,2,-3},new int[]{-1,1,-2,3,-4,4});
    states[1] = new State(new int[]{2,2});
    states[2] = new State(-1);
    states[3] = new State(-2);
    states[4] = new State(new int[]{24,6,1,190,2,-3},new int[]{-2,5,-4,4});
    states[5] = new State(-4);
    states[6] = new State(new int[]{37,7});
    states[7] = new State(new int[]{5,8,25,185});
    states[8] = new State(new int[]{32,181,33,182,31,183,30,184,6,-8,37,-13,14,-13,17,-13,18,-13,16,-13,15,-13},new int[]{-6,9,-7,11,-18,13,-19,179});
    states[9] = new State(new int[]{6,10});
    states[10] = new State(-5);
    states[11] = new State(new int[]{32,181,33,182,31,183,30,184,6,-8,37,-13,14,-13,17,-13,18,-13,16,-13,15,-13},new int[]{-6,12,-7,11,-18,13,-19,179});
    states[12] = new State(-9);
    states[13] = new State(new int[]{37,172,14,99,17,100,18,101,16,102,15,103},new int[]{-16,14,-17,97});
    states[14] = new State(new int[]{37,15});
    states[15] = new State(new int[]{3,16,56,17});
    states[16] = new State(-10);
    states[17] = new State(new int[]{30,169,14,99,17,100,18,101,16,102,15,103,37,168,4,-34},new int[]{-8,18,-9,161,-10,162,-20,165,-16,170,-17,97});
    states[18] = new State(new int[]{4,19});
    states[19] = new State(new int[]{5,20});
    states[20] = new State(new int[]{3,25,34,59,35,60,36,61,28,62,29,63,51,64,57,66,56,68,37,113,23,83,13,84,26,85,14,99,17,100,18,101,16,102,15,103,5,120,19,123,20,128,21,140,27,147,1,150,6,-19},new int[]{-3,21,-5,23,-13,26,-15,58,-14,109,-16,114,-17,97});
    states[21] = new State(new int[]{6,22});
    states[22] = new State(-11);
    states[23] = new State(new int[]{3,25,34,59,35,60,36,61,28,62,29,63,51,64,57,66,56,68,37,113,23,83,13,84,26,85,14,99,17,100,18,101,16,102,15,103,5,120,19,123,20,128,21,140,27,147,1,150,6,-19},new int[]{-3,24,-5,23,-13,26,-15,58,-14,109,-16,114,-17,97});
    ...
    states[120] = new State(new int[]{3,25,34,59,35,60,36,61,28,62,29,63,51,64,57,66,56,68,37,113,23,83,13,84,26,85,14,99,17,100,18,101,16,102,15,103,5,120,19,123,20,128,21,140,27,147,1,150,6,-19},new int[]{-3,121,-5,23,-13,26,-15,58,-14,109,-16,114,-17,97});
    ...
    states[126] = new State(new int[]{3,25,34,59,35,60,36,61,28,62,29,63,51,64,57,66,56,68,37,113,23,83,13,84,26,85,14,99,17,100,18,101,16,102,15,103,5,120,19,123,20,128,21,140,27,147,1,150},new int[]{-5,127,-13,26,-15,58,-14,109,-16,114,-17,97});
    states[127] = new State(-27);
    states[128] = new State(new int[]{56,129});
    states[129] = new State(new int[]{37,152,14,99,17,100,18,101,16,102,15,103},new int[]{-16,130,-17,97});
    states[130] = new State(new int[]{37,131});
    states[131] = new State(new int[]{38,132});
    ...
    states[133] = new State(new int[]{3,134,40,28,39,30,44,32,45,34,46,36,47,38,48,40,49,42,50,44,51,46,52,48,53,50,54,52,43,54,41,56,42,57});
    states[134] = new State(new int[]{34,59,35,60,36,61,28,62,29,63,51,64,57,66,56,68,37,75,23,83,13,84,26,85},new int[]{-13,135,-15,58,-14,71});
    states[135] = new State(new int[]{3,136,40,28,39,30,44,32,45,34,46,36,47,38,48,40,49,42,50,44,51,46,52,48,53,50,54,52,43,54,41,56,42,57});
    states[136] = new State(new int[]{34,59,35,60,36,61,28,62,29,63,51,64,57,66,56,68,37,75,23,83,13,84,26,85},new int[]{-13,137,-15,58,-14,71});
    states[137] = new State(new int[]{4,138,40,28,39,30,44,32,45,34,46,36,47,38,48,40,49,42,50,44,51,46,52,48,53,50,54,52,43,54,41,56,42,57});
    states[138] = new State(new int[]{3,25,34,59,35,60,36,61,28,62,29,63,51,64,57,66,56,68,37,113,23,83,13,84,26,85,14,99,17,100,18,101,16,102,15,103,5,120,19,123,20,128,21,140,27,147,1,150},new int[]{-5,139,-13,26,-15,58,-14,109,-16,114,-17,97});
    states[139] = new State(-28);
    states[140] = new State(new int[]{56,141});
    states[141] = new State(new int[]{34,59,35,60,36,61,28,62,29,63,51,64,57,66,56,68,37,75,23,83,13,84,26,85},new int[]{-13,142,-15,58,-14,71});
    states[142] = new State(new int[]{4,143,40,28,39,30,44,32,45,34,46,36,47,38,48,40,49,42,50,44,51,46,52,48,53,50,54,52,43,54,41,56,42,57});
    states[143] = new State(new int[]{3,25,34,59,35,60,36,61,28,62,29,63,51,64,57,66,56,68,37,113,23,83,13,84,26,85,14,99,17,100,18,101,16,102,15,103,5,120,19,123,20,128,21,140,27,147,1,150},new int[]{-5,144,-13,26,-15,58,-14,109,-16,114,-17,97});
    states[144] = new State(new int[]{22,145,3,-30,34,-30,35,-30,36,-30,28,-30,29,-30,51,-30,57,-30,56,-30,37,-30,23,-30,13,-30,26,-30,14,-30,17,-30,18,-30,16,-30,15,-30,5,-30,19,-30,20,-30,21,-30,27,-30,1,-30,6,-30});
    states[145] = new State(new int[]{3,25,34,59,35,60,36,61,28,62,29,63,51,64,57,66,56,68,37,113,23,83,13,84,26,85,14,99,17,100,18,101,16,102,15,103,5,120,19,123,20,128,21,140,27,147,1,150},new int[]{-5,146,-13,26,-15,58,-14,109,-16,114,-17,97});
    states[146] = new State(-31);
    states[147] = new State(new int[]{34,59,35,60,36,61,28,62,29,63,51,64,57,66,56,68,37,75,23,83,13,84,26,85},new int[]{-13,148,-15,58,-14,71});
    states[148] = new State(new int[]{3,149,40,28,39,30,44,32,45,34,46,36,47,38,48,40,49,42,50,44,51,46,52,48,53,50,54,52,43,54,41,56,42,57});
    states[149] = new State(-32);
    states[150] = new State(new int[]{3,151});
    states[151] = new State(-33);
    states[152] = new State(new int[]{12,153,8,-83,37,-83});
    states[153] = new State(new int[]{58,154});
    states[154] = new State(new int[]{34,59,35,60,36,61,28,62,29,63,51,64,57,66,56,68,37,75,23,83,13,84,26,85},new int[]{-13,155,-15,58,-14,71});
    states[155] = new State(new int[]{10,156,40,28,39,30,44,32,45,34,46,36,47,38,48,40,49,42,50,44,51,46,52,48,53,50,54,52,43,54,41,56,42,57});
    states[156] = new State(new int[]{34,59,35,60,36,61,28,62,29,63,51,64,57,66,56,68,37,75,23,83,13,84,26,85},new int[]{-13,157,-15,58,-14,71});
    states[157] = new State(new int[]{7,158,40,28,39,30,44,32,45,34,46,36,47,38,48,40,49,42,50,44,51,46,52,48,53,50,54,52,43,54,41,56,42,57});
    states[158] = new State(new int[]{4,159});
    states[159] = new State(new int[]{3,25,34,59,35,60,36,61,28,62,29,63,51,64,57,66,56,68,37,113,23,83,13,84,26,85,14,99,17,100,18,101,16,102,15,103,5,120,19,123,20,128,21,140,27,147,1,150},new int[]{-5,160,-13,26,-15,58,-14,109,-16,114,-17,97});
    states[160] = new State(-29);
    states[161] = new State(-35);
    states[162] = new State(new int[]{11,163,4,-36});
    states[163] = new State(new int[]{30,169,14,99,17,100,18,101,16,102,15,103,37,168},new int[]{-9,164,-10,162,-20,165,-16,170,-17,97});
    states[164] = new State(-37);
    states[165] = new State(new int[]{14,99,17,100,18,101,16,102,15,103,37,168},new int[]{-16,166,-17,97});
    states[166] = new State(new int[]{37,167});
    states[167] = new State(-39);
    states[168] = new State(-83);
    states[169] = new State(-38);
    states[170] = new State(new int[]{37,171});
    states[171] = new State(-40);
    states[172] = new State(new int[]{56,173,8,-83,37,-83});
    states[173] = new State(new int[]{30,169,14,99,17,100,18,101,16,102,15,103,37,168,4,-34},new int[]{-8,174,-9,161,-10,162,-20,165,-16,170,-17,97});
    states[174] = new State(new int[]{4,175});
    states[175] = new State(new int[]{5,176});
    states[176] = new State(new int[]{3,25,34,59,35,60,36,61,28,62,29,63,51,64,57,66,56,68,37,113,23,83,13,84,26,85,14,99,17,100,18,101,16,102,15,103,5,120,19,123,20,128,21,140,27,147,1,150,6,-19},new int[]{-3,177,-5,23,-13,26,-15,58,-14,109,-16,114,-17,97});
    states[177] = new State(new int[]{6,178});
    states[178] = new State(-12);
    states[179] = new State(new int[]{32,181,33,182,31,183,30,184,37,-13,14,-13,17,-13,18,-13,16,-13,15,-13},new int[]{-18,180,-19,179});
    ...
    states[186] = new State(new int[]{5,187});
    states[187] = new State(new int[]{32,181,33,182,31,183,30,184,6,-8,37,-13,14,-13,17,-13,18,-13,16,-13,15,-13},new int[]{-6,188,-7,11,-18,13,-19,179});
    states[188] = new State(new int[]{6,189});
    states[189] = new State(-6);
    states[190] = new State(new int[]{3,191});
    ...
    rules[28] = new Rule(-5, new int[]{20,56,-16,37,38,-13,3,-13,3,-13,4,-5});
